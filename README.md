...
> <p align="center"><b>DETECT. RESTORE. ENHANCE. VERIFY.</b></p>
...
- [FACE IMAGE ENHANCEMENT AND RESTORATION](#face-image-enhancement-and-restoration)
  ...
  - [💬 FEATURES](#-features)
  - [⚙️ THE PIPELINE ARCHITECTURE](#️-the-pipeline-architecture)
...
- **WORKSHOP/** – CONTAINS HANDS-ON MATERIALS INCLUDING NOTEBOOK AND DATA.
  - **NOTEBOOK.ipynb** – MAIN NOTEBOOK DEMONSTRATING THE COMPLETE FACE RESTORATION PIPELINE.
  - **DATA/** – SAMPLE INPUT IMAGES AND DATASETS USED FOR TESTING AND DEMONSTRATION.

- **DOCS/** – PROJECT DOCUMENTATION AND TECHNICAL DETAILS.
  - **ENVIRONMENT_SETUP.md** – INSTALLATION GUIDE AND GPU/CUDA CONFIGURATION.
  - **FACE_IMAGE_RESTORATION_PIPELINE.md** – DETAILED PIPELINE ARCHITECTURE AND WORKFLOW.
  - **MODEL_DETAILS.md** – DESCRIPTION AND SPECIFICATIONS OF ALL MODELS USED.
...
`LOW-QUALITY INPUT` ➜ [FACE DETECTION & ALIGNMENT] ➜ [DENOISING] ➜ [SEMANTIC RESTORATION] ➜ [SUPER-RESOLUTION] ➜ [COLOR ENHANCEMENT] ➜ `HIGH-RES OUTPUT`

> DATA FLOW CONTRACT

- INPUT: NUMPY ARRAY `(H × W × C)`, RGB, FLOAT32
- OUTPUT: NUMPY ARRAY `(H × W × C)`, RGB, FLOAT32
